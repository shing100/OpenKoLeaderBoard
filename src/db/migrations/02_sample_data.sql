...
DO $$
BEGIN
  INSERT INTO models (name, kmmlu, gsm8k, gsm8k_ko, ifeval, haerae, kobest, mmlu, mmlu_pro, bbh, csatqa, gpqa, arc_c, average)
  VALUES
  ...
  INSERT INTO logickor (name, math_singleton, math_multiturn, grammar_singleton, grammar_multiturn, 
    ...
    reasoning_singleton, reasoning_multiturn, coding_singleton, coding_multiturn, average)
  VALUES
  ...
  INSERT INTO rag (service, generator, parser, semantic, lexical, web, rerank, fusion, 
    finance, public, medical, law, commerce, total)
  VALUES
